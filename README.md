...
## Software developer, Junior Project manager 👨🏽‍🔧, aspirant IT writer and DevOps enthusiast 🧰
...
- 🛠️ Also Working on a CLI tool to automate repeating processes I used to do on the start of every project [Dev tools](https://github.com/IT-WIBRC/dev-tools) This can be useful for any dev too, so feel free to use it and make feedbacks. At the same time i've also made an [eslint config 👨🏽‍🔧](https://github.com/IT-WIBRC/eslint-config-epsvue) to reduce the repeated process of doing it on all my vuejs project too.  
- 🗞️ Shared my experience while working and this is visible on this repository [Code remarks](https://github.com/IT-WIBRC/coding-remarks)
- 🪩 Also share my experience of pattern used for internationalization here using vuejs [better i18n](https://github.com/IT-WIBRC/better-i18n)
- 🐍 While leraning python, i made some [projects 🐍](https://github.com/IT-WIBRC/python-learning-projects) and i will continue as continious learning is the modo 
- 🤖 By curiosity after my first experience i tried to reproduce the Jenkins config we were using on the server and also for just a single project. [Here it is](https://github.com/IT-WIBRC/vue-ci-cd-app-jenkins-nginx)
- 🖇️ As contribution and sharing is something natural, there is this repo where all the [resources(links) for developers to locate websites and platforms which can be useful to learn and improve](https://github.com/IT-WIBRC/Dev-and-it-ressource)
...
![Linux](https://img.shields.io/badge/Linux-FCC624?style=for-the-badge&logo=linux&logoColor=black) ![macOS](https://img.shields.io/badge/mac%20os-000000?style=for-the-badge&logo=macos&logoColor=F0F0F0) ![Ubuntu](https://img.shields.io/badge/Ubuntu-E95420?style=for-the-badge&logo=ubuntu&logoColor=white)

### Socials

[![LinkedIn](https://img.shields.io/badge/linkedin-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/waffeu-ivany-botrel-rayn) [![Dev.to blog](https://img.shields.io/badge/dev.to-0A0A0A?style=for-the-badge&logo=dev.to&logoColor=white)](https://dev.to/it-wibrc) [![GitHub](https://img.shields.io/badge/github-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/IT-WIBRC) [![X (formerly Twitter) Follow](https://img.shields.io/twitter/follow/:IT_WIBRC)](https://x.com/IT_WIBRC)  [![CoderLegion](https://coderlegion.com/cl_badge_logo1.png)](https://coderlegion.com/user/Waffeu+Rayn)
